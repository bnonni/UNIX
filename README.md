...
* [Sed](Shell-Scripting/Sed) - SED (stand for **__S__**tream **__ED__**itor) is a Unix utility that parses and transforms text, using a simple, compact programming language. 
